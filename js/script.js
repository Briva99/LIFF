let menu = [
	{ id: 1, nama: 'Lontong Kupang', kategori: 'Makanan', harga: 10000, foto: 'Lontong kupang.png'},
	{ id: 2, nama: 'Rujak Cingur', kategori: 'Makanan', harga: 15000, foto: 'rujak.png'},
	{ id: 3, nama: 'Tahu Lontong', kategori: 'Makanan', harga: 12000, foto: 'Tahulontong.png'},
	{ id: 4, nama: 'Penyetan Wader', kategori: 'Makanan', harga: 9000, foto: 'wader.png'},
	{ id: 5, nama: 'Es Degan', kategori: 'Minuman', harga: 6000, foto: 'es Degan'},
	{ id: 6, nama: 'Sinom', kategori: 'Minuman', harga: 4000, foto: 'sinom.png'},
	{ id: 7, nama: 'Beras Kencur', kategori: 'Minuman', harga: 4000, foto: 'beraskencur.png'},
	{ id: 8, nama: 'Ronde', kategori: 'Minuman', harga: 7000, foto: 'ronde.png'},
	{ id: 9, nama: 'Ote-ote', kategori: 'Cemilan', harga: 1000, foto: 'ote-ote.png'},
	{ id: 10, nama: 'Kelepon', kategori: 'Cemilan', harga: 9090, foto: 'kelepon.png'}
]
...
function loadMenu(){
	...
	for (i in data_menu){
		...
		if(data_menu[i].kategori == 'Makanan'){
			data_food += menu_item
		} else if(data_menu[i].kategori == 'Minuman'){
			data_drink += menu_item
		} else if(data_menu[i].kategori == 'Cemilan'){
